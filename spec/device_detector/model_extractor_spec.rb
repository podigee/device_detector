  ...
  describe '#call' do
    describe 'when matching against dynamic model' do
      ...
      describe 'when a dynamic match is found' do
        let(:user_agent) do
          'Mozilla/5.0 (iPhone 5S; CPU iPhone OS 8_1_3 like Mac OS X) AppleWebKit/600.1.4 (KHTML, like Gecko) Version/8.0 Mobile/12B466 Safari/600.1.4'
        end
    ...
    describe 'when matching against static model' do
      let(:user_agent) do
        'Mozilla/5.0 (iPhone; CPU iPhone OS 8_0 like Mac OS X) AppleWebKit/600.1.4 (KHTML, like Gecko) Mobile/12A365 Weibo (iPhone7,2)'
      end
